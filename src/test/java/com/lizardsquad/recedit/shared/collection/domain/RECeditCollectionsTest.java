package com.lizardsquad.recedit.shared.collection.domain;
...
@UnitTest
class RECeditCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class RECeditCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = RECeditCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = RECeditCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class RECeditCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = RECeditCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = RECeditCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class RECeditCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = RECeditCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = RECeditCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class RECeditMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = RECeditCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = RECeditCollections.immutable(input);
